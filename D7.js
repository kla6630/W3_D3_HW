...
const changeTitle = () => {
  ...
  h1.innerText = "Questo è il nuovo titolo della pagina";
};
changeTitle();
...
const changePcontent = () => {
  ...
  for (let i = 0; i < newP.length; i++) {
    newP[i].innerText = "nuovo testo paragrafo";
  }
};
changePcontent();
...
const addParagraph = function () {
  ...
  const padre = document.querySelectorAll(`div`)[0];
  console.log(padre);
  newParagraph.innerText = "Nuovo Paragrafo al primo div";
  padre.appendChild(newParagraph);
};
addParagraph();
